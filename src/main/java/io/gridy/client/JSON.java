...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.gridy.client.model.ApiRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.gridy.client.model.ModelApiResponse.CustomTypeAdapterFactory());
